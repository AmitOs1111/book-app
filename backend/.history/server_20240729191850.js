...
app.get('/api/bug', (req, res) => {
  ...
  bookService.query(filterBy).then((bugs) => res.send(bugs))
})
...
app.post('/api/bug', (req, res) => {
  ...
  bookService.save(bug, user).then((bug) => {
    console.log('bug', bug)
    res.send(bug)
  })
})
...
app.put('/api/bug', (req, res) => {
  const bug = req.body
  bookService.save(bug).then((car) => res.send(car))
})

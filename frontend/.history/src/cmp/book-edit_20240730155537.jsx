...
import { addBook, updateBook } from '../store/book.action'
...
export function BookEdit({ togglePrepareBook }) {
  ...
  function onAddBook() {
    if (book._id) {
      updateBook(book).then(() => onCloseBookEdit())
    } else addBook(book).then(() => onCloseBookEdit())
  }
  ...
  return (
    <section className="book-edit">
      ...
      <button onClick={() => onAddBook(book)}>Submit</button>
    </section>
  )
}
